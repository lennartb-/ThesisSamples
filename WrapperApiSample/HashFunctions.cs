...
namespace WrapperApiSample
{
    public static class HashFunctions
    {
        ...
        /// <returns>The SHA512-hashed equivalent of <paramref name="input"/>,
        /// as a uppercase hex string without dashes.</returns>
        ...
        /// </summary>
        /// <param name="input">An UTF8 string to hash.</param>
        /// <returns>The SHA256-hashed equivalent of <paramref name="input"/>,
        /// as a uppercase hex string without dashes.</returns>
        ...
        /// </summary>
        /// <param name="input">An UTF8 string to hash.</param>
        /// <returns>The MD5-hashed equivalent of <paramref name="input"/>,
        /// as a uppercase hex string without dashes.</returns>
